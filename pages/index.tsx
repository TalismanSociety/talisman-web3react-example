...
import { UserRejectedRequestError as UserRejectedRequestErrorTalisman } from "../talisman/TalismanConnector";
...
function App() {
  ...
  // [Talisman] commented useEagerConnect call below as it's logic will prioritize connecting with metamask exclusively.
  // Our recommendation is to save last used connector in local storage, and attempt to connect to it when app mounts.
